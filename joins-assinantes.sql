...
CREATE TABLE Ramo_Atividade (cd_ramo INT PRIMARY KEY, ds_ramo VARCHAR(50)); CREATE TABLE Tipo_Assinante (cd_tipo INT PRIMARY KEY, ds_tipo VARCHAR(50)); CREATE TABLE Municipio (cd_municipio INT PRIMARY KEY, ds_municipio VARCHAR(50)); CREATE TABLE Assinante ( cd_assinante INT PRIMARY KEY, nm_assinante VARCHAR(100), cd_ramo INT, cd_tipo INT, FOREIGN KEY (cd_ramo) REFERENCES Ramo_Atividade(cd_ramo), FOREIGN KEY (cd_tipo) REFERENCES Tipo_Assinante(cd_tipo) ); CREATE TABLE Endereco ( cd_endereco INT PRIMARY KEY, ds_endereco VARCHAR(100), cd_assinante INT, cd_municipio INT, FOREIGN KEY (cd_assinante) REFERENCES Assinante(cd_assinante), FOREIGN KEY (cd_municipio) REFERENCES Municipio(cd_municipio) ); CREATE TABLE Telefone ( cd_fone INT PRIMARY KEY, n_fone VARCHAR(20), cd_endereco INT, FOREIGN KEY (cd_endereco) REFERENCES Endereco(cd_endereco) );
SELECT * FROM Ramo_Atividade;
SELECT * FROM Tipo_Assinante;
SELECT * FROM Municipio; 
SELECT * FROM Assinante; 
